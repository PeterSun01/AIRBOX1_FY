...
static void user_post_property(void)
{
    ...
    {		
        ...
        cJSON_AddItemToObject(root, "CurrentTemperature", cJSON_CreateNumber(Temperature));
        cJSON_AddItemToObject(root, "CurrentHumidity", cJSON_CreateNumber((int)Humidity)); 
